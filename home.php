...
$result = array(); // Inisialisasi variabel untuk menyimpan hasil menu
while ($row = mysqli_fetch_array($query)) {
    $result[] = $row;
}

// Query untuk mengambil data chart (jumlah pesanan per menu)
...
$result_chart = array(); // Inisialisasi array untuk menyimpan data chart
